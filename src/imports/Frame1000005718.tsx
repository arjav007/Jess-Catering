...
function Frame2() {
  return (
    <div className="bg-[#6b8a47] content-stretch flex items-center justify-center px-[28px] py-[16px] relative rounded-[10px] shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[16px] text-white">Order Now</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <p className="font-['Abhaya_Libre_SemiBold:Regular',sans-serif] leading-[64px] not-italic relative shrink-0 text-[#6b8a47] text-[52px] w-[441px] whitespace-pre-wrap">Order With Ease</p>
      <Container />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#6e564a] text-[20px] w-[504px] whitespace-pre-wrap">Select your dishes, share your event details, and review before confirming — a seamless, handcrafted experience.</p>
      <Frame2 />
    </div>
  );
}
