...
export function StepReview({ 
  ...
  const deliveryFee = orderDetails.deliveryType === 'delivery' ? 10 : 0;
    ...
    <div className="min-h-screen py-12 px-4 md:px-6 bg-[#ffffff]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          >
            Confirm your chocolates and order details before submitting.
          </p>
        </motion.div>
          ...
          <div className="mb-9">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                { label: 'Order Type', value: orderDetails.orderType },
                { label: 'Delivery', value: orderDetails.deliveryType },
                { label: 'Date', value: orderDetails.deliveryDate },
                { label: 'Payment', value: orderDetails.paymentMethod || 'Not specified' },
              ].map((detail, index) => (
                <div
                  key={detail.label}
